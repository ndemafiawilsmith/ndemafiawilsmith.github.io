...
if(isset($_POST['submit'])){
    $to = 'wilsmithndemafia@gmail.com.com';
    $subject = 'Message From Portfolio';
    $email = $_POST['email'];
    $message = $_POST['message'];
    $name = $_POST['name'];
    $message = $name."  Sent you a message : Email : ".$email." message:".$message;
    $headers = "From: ndemafia@interna.com.ng.com\r\n";
if (mail($to, $subject, $message, $headers)) {
   ...
   <i class="bi bi-check-circle me-1"></i>
   Sorry there was an error while sending message
   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
 </div>';
}
}
...
<head>
    ...
    <title>Ndemafia Wilsmtih | Home</title>
    <!-- font icons -->
    ...
    <header class="header">
        <div class="container">
            <ul class="social-icons pt-3">
                <li class="social-item"><a class="social-link" href="https://www.facebook.com/ndemafiawilsmith"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="https://twitter.com/NdemafiaWilsmi1"><i class="ti-twitter" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="https://www.linkedin.com/in/ndemafiawilsmith/"><i class="ti-linkedin" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="https://www.instagram.com/ndemafiawilsmith/"><i class="ti-instagram" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link" href="https://github.com/ndemafiawilsmith"><i class="ti-github" aria-hidden="true"></i></a></li>
            </ul>  
            <div class="header-content">
                <h4 class="header-subtitle" >Hello, I am</h4>
                <h1 class="header-title">Ndemafia Wilsmith</h1>
                <h6 class="header-mono" >Web Developer | Multi platform Systms Admin</h6>
                <a href="resumee.pdf" target="_blank"><button class="btn btn-primary btn-rounded"><i class="ti-printer pr-2"></i>Print Resume</button></a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="assets/imgs/ndem.jfif" alt="" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">Ndemafia Wilsmith</h5>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A Web Designer / Multi Platform Systems Administrator</h5>
                <p class="mt-20">I build Websites, I manage Windows, Linux and solaris Servers. I design and manage network systems. I design graphical cards like banners, fliers and invitation cards.</p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    ...
                    <li><span>Email</span> : ndemafia@interna.com</li>
                    <li><span>Phone</span> : +234 8100502093</li>
                    <li><span>LinkedIn</span> : ndemafiawilsmith </li>
                    <li><span>Address</span> : Borromeo Junction,  Awka Road, Onitsha</li>
                </ul>
                <ul class="social-icons pt-3">
                    <li class="social-item"><a class="social-link" href="https://www.facebook.com/ndemafiawilsmith"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                    <li class="social-item"><a class="social-link" href="https://twitter.com/NdemafiaWilsmi1"><i class="ti-twitter" aria-hidden="true"></i></a></li>
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Multi Platform Systems Admin</h6>
                        <p class="subtitle">Build and Deploy Servers.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">Design Banners and fliers.</p>
                        <hr>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row">
                        <div class="col-5 text-right text-light border-right py-3">
                            <div class="m-auto"><i class="ti-cup icon-xl"></i></div>
                        </div>
                        <div class="col-7 text-left py-3">
...
<!-- 
    ...
    <section class="section bg-dark py-5">
        <div class="container text-center">
           ...
           <a href="https://www.facebook.com/ndemafiawilsmith"> <button class="btn bg-primary w-lg" >Hire me</button></a>
        </div>
    </section>
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/interna.JPG" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="assets/imgs/interna.JPG"></a>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/dr.JPG" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="assets/imgs/dr.JPG"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/harry.JPG" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                         
                            <div class="content-holder">
                                <a class="img-popup" href="assets/imgs/harry.JPG"></a>
                                <div class="text-holder">
                                    <h6 class="title">Web</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/sunday.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                        
                            <div class="content-holder">
                                <a class="img-popup" href="assets/imgs/sunday.jpg"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="assets/imgs/church3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                            <div class="content-holder">
                                <a class="img-popup" href="assets/imgs/church3.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="contact-form-card">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group ">
                                <button type="submit" name="submit" class="form-control btn btn-primary" >Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+234 8100502093</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Borromeo Junction,  Awka Road, Onitsha</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">wilsmithndemafia@gmail.com</span></h6>
                            </div>
                        </div>
